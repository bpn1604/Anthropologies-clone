    ...
    <div>
      ...
      >
        <div className="carousel-inner" style={{ height: "40px" }}>
          <div
            style={{ background: "rgb(195,0,55)" }}
            className="carousel-item active "
          >
            <div className="d-flex  justify-content-center">
              <p className={`${styles.para} ${styles.small}`}>
                look polished , dress sharp JUST IN SUIT & TIE
              </p>
          ...
          <div style={{ background: "#0050ff" }} className="carousel-item">
            <div className="d-flex  justify-content-center">
              <p className={`${styles.para} ${styles.small}`}>
                new styles added!
              </p>
              <p className={styles.para}>
                25% OFF SELECT BEDDING , PILLOW , RUGS & MORE
              </p>
              <a className={styles.link} href="/">
                shop, online exclusive - see details
              </a>
            </div>
          </div>
        </div>
      ...
      >
        <div className={`mx-3 ${styles.cont}`} style={{ display: "flex" }}>
        ...
        <div className={`me-5 ${styles.cont}`}>
          ...
          )} */}
          {
            ...
            (
              <Flex gap="10px">
              <img style={{height:"20px", width:"20px"}} src="https://th.bing.com/th/id/OIP.JYD61YlL9cqPVyiKEMWplAHaHa?w=180&h=180&c=7&r=0&o=5&pid=1.7" />
              <span onClick={handleLogout} className={styles.spans}>
                SignIn
              </span>
              /              
      ...
      >
        <div className="d-flex  ms-5" style={{ height: "90px" }}>
          <div
            onClick={gotohome}
            className="py-3"
            style={{
      ...
      <div className="d-flex" style={{ borderBottom: "1px solid #d3d3d3" }} hover={{border:"red"}}>
